...
Through a separation of variables, the tangent compliance governing dilation found in Eqn.~(\ref{membraneCompliance}) can be integrated to produce a secant compliance of
\begin{equation}
