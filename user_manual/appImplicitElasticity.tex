...
Upon substituting the Gibbs free-energy function (Eq.~\ref{GreenFiberEnergy}) into the constitutive equations (Eqs.~\ref{fiberEntropy} and \ref{fiberStrain}) governing entropy and strain, respectively, results in the matrix expression
\begin{displaymath}
\left\{ \begin{matrix}
\eta - \eta_0 \\ \ln (L / L_0)
...
Upon differentiating the constitutive equations for entropy and dilation found in Eqs.~\ref{membraneEntropy} and \ref{membraneDilation}, respectively, assuming they are both sufficiently differentiable functions of state, while adopting the Gibbs free energy from Eq.~\ref{membraneUniform}, results in the following matrix constitutive equation
\begin{displaymath}
\left\{ \begin{matrix}
