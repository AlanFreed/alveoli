...
def run():
    ...
    for j in range(curves):
        ...
        E1, E2, e_t, e_max = mp.collagenFiber()
        resp = bioFiber(ctrlVec, respVec, rho, Cp, alpha, E1, E2, e_t, e_max)
    ...
    plt.ylabel(r'stress  $s$  (barye)', fontsize=18)
    ...
    plt.ylabel(r'entropy density  $\eta$  (erg/g.K)', fontsize=16)
