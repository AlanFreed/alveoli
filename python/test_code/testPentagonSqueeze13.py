...
def run():
    ...
    for i in range(steps):
        ...
        pureShear[i] = log((piF0[2, 2] / piF0[0, 0])**(1.0/3.0))
        d.update(piF0)
        d.advance(pi)
    ...
    plt.xlabel(r'Far-Field $\ln \sqrt{c/a}$', fontsize=16)
    ...
    plt.title(r"Directions 1 \& 3", fontsize=20)
    plt.legend([line1, line2, line3],
               ["pentagon 1", "pentagon 2", "pentagon 5"],
               bbox_to_anchor=(0.025, 0.975), loc=2, fontsize=14)
    plt.xlabel(r'Far-Field $\ln \sqrt{c/a}$', fontsize=16)
    ...
    plt.savefig('pentagonalPureShear13.jpg')
