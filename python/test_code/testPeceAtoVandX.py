...
def test():
    ...
    print("  z     = {} inches.".format(12. * x0[0]))
    print("  theta = {} degrees.".format((180. / math.pi) * x0[1]))
    print("  phi   = {} degrees.".format((180. / math.pi) * x0[2]))

    solver = pece(car.getA, t0, x0, v0, h, tol)

    resultsE = []
    resultsH = []
    resultsP = []
    resultsR = []
    resultsE.append((t0, tol))               # time and error
